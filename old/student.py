...
class Student:
    ...
    def add_course(self, new_course):
        ...
        If self is already enrolled in new_course, raise StudentAlreadyEnrolledError.
    ...
    def drop_course(self, course_obj):
        ...
        If self is not taking course_obj, do nothing. Assumes course_obj is 
    ...
    def is_taking_course(self, course_obj):
        ...
        Return the index of a given course_obj in list of courses self is taking, if index not found,return -1 
    ...
    def compare(self, student):
        ...
        student in alphabetical order. Assuming self and student are both taking at least one common course.
        
        Parameters:
        - student: the student we want to compare self with for common enrolled 
        courses
        """
        # assume self and student taking course
        common_list = []
...
class Course:
    ...
    def student_index(self, student_obj):
        ...
        Return the index of student_obj in self.students. If not found, 
        return -1.
        """
        i = 0
    ...
    def add_student(self, student):
        ...
        Append student to self.students if not already appended.
        """
    ...
    def student_list(self):
        ...
        Return a list of student names in self.studnets in alphabetical order.
        """
